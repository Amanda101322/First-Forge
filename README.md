...
1. **Clone the repository**: 
   ```bash
   git clone https://github.com/Amanda101322/First-Forge.git
...
Built with care. Pages, projects, and experiments  will continue to evolve as I learn and build more.
